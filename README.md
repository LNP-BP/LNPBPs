...
|                   7 | Commitment schemes  | Commitments for structural and hierarchical data                                                                | Maxim Orlovsky                           | Standard      | Proposal |
|  [8](lnpbp-0008.md) | Commitment schemes  | Single-use-seals                                                                                                | Peter Todd                               | Informational | Draft    |
...
|                  11 | Commitment schemes  | Anchoring multiple deterministic bitcoin commitments in the same transaction output                             | Maxim Orlovsky                           | Standard      | Final    |
|                  12 | Commitment schemes  | TapRet: Taproot script tree-based OP_RETURN deterministic bitcoin commitments                                   | Maxim Orlovsky et al                     | Standard      | Final    |
| [13](lnpbp-0013.md) | Smart contracts     | RGB: Client-side-validated confidential smart contracts for Bitcoin and Lightning Network                       | Maxim Orlovsky et al                     | Informational | Draft    |
|                  14 | Smart contracts     | RGB Schema: client-side validation rules for RGB smart contracts                                                | Maxim Orlovsky                           | Standard      | Planned  |
|                  15 | Smart contracts     | RGB client-side verification and data serialization                                                             | Maxim Orlovsky                           | Standard      | Planned  |
|                  16 | Smart contracts     | AluVM instruction set architecture extensions for handling RGB state validation                                 | Maxim Orlovsky                           | Standard      | Planned  |
...
| [31](lnpbp-0031.md) | *Reserved*          | Standard Contractum Library (SCL)                                                                               | Maxim Orlovsky                           | Standard      | Draft    |
