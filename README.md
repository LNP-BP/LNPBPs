...
[33](https://github.com/LNP-BP/LNPBPs/issues/24) | Client-validated data (3) | Lightning network protocol | Lightspeed: micro-payments for Lightning Network | Maxim Orlovsky | Draft
...
[35](https://github.com/LNP-BP/LNPBPs/pull/97) | OSI Application (i7) | Lightning network protocol | Bifrost: LN message extensions for RGB data propagation | Maxim Orlovsky | Standard | Planned
...
[39](lnpbp-0039.md) | Transaction graph (2) | Bitcoin protocol | Bitcoin transaction output-based single-use-seals with sign-to-contract commitments | Maxim Orlovsky et al | Standard | Planned
